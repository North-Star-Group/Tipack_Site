...
export default function BrandsPage() {
  // --- COSTANTI DI DESIGN ---
  const TAPE_COLOR = "%23F4D03F"; // Giallo
  ...
  // --- DATI DI ESEMPIO: LA FLOTTA ---
  const brands = [
    {
      name: "IRON ROAST",
      icon: Coffee,
      desc: "Caffè industriale",
      est: "DAL 2021",
    },
    {
      name: "VOLT TECH",
      icon: Zap,
      desc: "Componenti hardware",
      est: "DAL 2019",
    },
    {
      name: "NORTH PORT",
      icon: Anchor,
      desc: "Forniture marine",
      est: "DAL 1998",
    },
    { name: "VINYL HEAVY", icon: Disc, desc: "Etichetta discografica", est: "DAL 2023" },
    {
      name: "CORE DRILL",
      icon: Target,
      desc: "Strumenti da costruzione",
      est: "DAL 2015",
    },
    {
      name: "HEX LABS",
      icon: Hexagon,
      desc: "Ricerca chimica",
      est: "DAL 2020",
    },
  ];
  ...
  const testimonials = [
    {
      id: "LOG-01",
      company: "IRON ROAST",
      text: "Le nostre scatole precedenti si rompevano al minimo sguardo. Queste casse hanno resistito a un test di corriere con calcio volante. Ne abbiamo ordinate altre 5.000.",
      author: "Sarah J. // Direttrice Operativa",
    },
    {
      id: "LOG-02",
      company: "VOLT TECH",
      text: "Finalmente un packaging che non sembra uscito da un negozio di regali. Si abbina perfettamente al nostro hardware. Bello, resistente, economico.",
      author: "Mike R. // Ingegnere Capo",
    },
  ];

  return (
    <div className="min-h-screen bg-[#FFFEF9] text-[#2D2424] font-sans pt-24 pb-0 relative overflow-x-hidden">
      {/* Texture di sfondo globale */}
      <div
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 mb-20 flex flex-col items-center text-center md:items-start md:text-left">
          ...
          <p className="text-xl font-bold max-w-2xl leading-snug">
            Forniamo i marchi che costruiscono cose. Se vendi candele profumate,
            vai altrove. Se spedisci pezzi di motore, kettlebell o sintetizzatori,
            sei nel posto giusto.
          </p>
        </div>

        {/* --- TICKER INFINITO (STILE NASTRO DI PERICOLO) --- */}
        <div className="w-full bg-[#F4D03F] border-y-2 border-black py-3 overflow-hidden whitespace-nowrap mb-20 relative transform -rotate-1 scale-105 shadow-[0px_4px_10px_rgba(0,0,0,0.1)]">
          <div className="animate-marquee inline-block">
            {[...Array(10)].map((_, i) => (
              ...
              >
                ★ SCELTO DALLA MINORANZA CHE FA RUMORE ★ SPEDISCI PESANTE ★
              </span>
            ))}
          </div>
        </div>
        ...
        {/* --- TESTIMONIANZE (REPORT SUL CAMPO) --- */}
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="md:w-1/3">
                ...
                <p className="text-gray-400 font-mono text-sm max-w-xs">
                  Comunicazioni intercettate da responsabili logistici e di magazzino che usano davvero i nostri prodotti.
                </p>
              </div>
